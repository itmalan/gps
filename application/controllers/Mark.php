...
class Mark extends MY_Controller
{
        ...
        public function add_student_fn($course_id)
	{
         ...
         */
         ...
         public function update_internal_mark_fn(){
           ...
           if($this->input->post('action')=='edit'){
               ...
               if(!empty($this->input->post('internal1'))){
               $data=array('internal1'=>$this->input->post('internal1'));
               $where=array(
               ...
               else if(!empty($this->input->post('internal2'))){
               $data=array('internal2'=>$this->input->post('internal2'));
               $where=array(
                   'reg_number'=>$reg_number,
                   'subject_id'=>$subject_id,
                       );
               ...
               else if(!empty($this->input->post('other'))){
               $data=array('other'=>$this->input->post('other'));
               $where=array(
                   'reg_number'=>$reg_number,
                   'subject_id'=>$subject_id,
                       );
        ...
        //Updating external marks called from ajax inline change
         public function update_external_mark_fn(){
           ...
           if($this->input->post('action')=='edit'){
               ...
               if(!empty($this->input->post('external1'))){
               $data=array('external1'=>$this->input->post('external1'));
               $where=array(
                   'reg_number'=>$reg_number,
                   'subject_id'=>$subject_id,
                       );
               ...
               else if(!empty($this->input->post('external2'))){
               $data=array('external2'=>$this->input->post('external2'));
               $where=array(
                   'reg_number'=>$reg_number,
                   'subject_id'=>$subject_id,
                       );
        ...
        public function update_overall_mark_fn(){
           ...
           if($this->input->post('action')=='edit'){
               ...
               else if(!empty($this->input->post('external1'))){
               $data=array('external1'=>$this->input->post('external1'));
               $where=array(
                   'reg_number'=>$reg_number,
                   'subject_id'=>$subject_id,
