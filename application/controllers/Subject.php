            ...
            // For getting course list
               ...
               if ($this->_chk_user()&& $this->userDetails['role']==3){
                   ...
                   foreach ($data as $item){
                       ...
                       //$total_mark=$item->total_internal+$item->total_external;
