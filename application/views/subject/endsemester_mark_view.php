...
$this->table->set_heading(array('ID','Sl. No','Register Number','Name','End Semester Mark1 <br/>/60','End Semester Mark2 <br/>/60','Total End Semester Mark <br/>/60'));
...
$('#externalMarksTable').Tabledit({
    "url": "<?php echo site_url('mark/update_external_mark_fn/')?>",
