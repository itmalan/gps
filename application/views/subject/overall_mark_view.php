...
$this->table->set_heading(array('ID','Sl. No','Register Number','Name','Internal Mark1 </br>/15','Internal Mark2 </br>/15','Other Mark </br>/10','Total Internal Mark</br>/40','End Semester Mark1 </br>/60','End Semester Mark2 </br>/60','Total End Semester Mark </br>/60','Total Mark </br> /100','Grade'));
...
$('#overallMarksTable').Tabledit({
    "url": "<?php echo site_url('mark/update_overall_mark_fn/')?>",
